...
let encrypt = crypto.createCipher("aes-256-ctr",utfString).update(text, 'utf-8','hex');
console.log({encrypt});
let decrypt = crypto.createDecipher("aes-256-ctr",utfString).update(encrypt,'hex', 'utf-8');
console.log({decrypt});
})()
